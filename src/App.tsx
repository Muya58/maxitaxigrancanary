    ...
    <div className="min-h-screen bg-bg-deep selection:bg-brand/30">
      ...
      <main className="lg:flex lg:h-screen lg:pt-20 overflow-hidden">
        ...
        <section className="flex-1 gradient-dark p-8 lg:p-24 flex flex-col justify-center relative border-r border-white/5 pt-32 lg:pt-0 overflow-y-auto">
          ...
          {/* --- BOTÓN MÓVIL ANTI-REBOTE --- */}
          <div className="mt-8 md:hidden flex flex-col items-center gap-3">
            <a 
              href="https://wa.me/34619735892" 
              className="w-full bg-[#25D366] text-white py-4 px-6 rounded-xl font-black text-xl flex items-center justify-center gap-3 shadow-[0_0_20px_rgba(37,211,102,0.4)] animate-pulse"
            >
            ...
            <p className="text-slate-400 text-xs text-center font-bold uppercase tracking-widest">Confirmación inmediata, 24h</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-20 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <div className="flex items-center gap-6 grayscale opacity-30 hover:grayscale-0 hover:opacity-100 transition-all">
              ...
              {/* --- BOTON FLOTANTE DE WHATSAPP GLOBAL --- */}
      <a 
        href="https://wa.me/34619735892" 
        target="_blank" 
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-50 bg-[#25D366] text-white p-4 rounded-full shadow-lg hover:bg-[#20bd5a] hover:scale-110 transition-transform duration-300 flex items-center justify-center animate-bounce"
        aria-label="Contactar por WhatsApp 24h"
      >
